...
@RestController
@RequestMapping("/api/v1/pharmacy-product-outcomes")
@RequiredArgsConstructor
public class PharmacyProductOutcomeController {

    private final PharmacyProductOutcomeService service;

    @PostMapping
    public PharmacyProductIncomeDto create(@RequestBody PharmacyProductOutcomeReq req) {
    ...
    @PutMapping("/{id}")
    public PharmacyProductIncomeDto update(@PathVariable Long id, @RequestBody PharmacyProductOutcomeReq req) {
